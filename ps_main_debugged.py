...
filepaths='C:/Users/janma/Downloads/data.json'
...
def get_thor_wonder_woman(data):
    info=[]
    info.append(data["AVENGERS"]["Thor"])
    info.append(data["DC"]["Wonder Woman"])
    print(info)
    return info
...
def get_steve_superman(data):
    info=[]
    info.append(data["AVENGERS"]["Captain America"])
    info.append(data["DC"]["Superman"])
    print(info)
    return info
